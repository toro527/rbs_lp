  ...
  data() {
    return {
      ...
      about: [
        {
          icon: "cash-multiple",
          text: "技術と経営知識を身につければ継続、永続的に稼ぐことができる",
        },
        {
          icon: "youtube",
          text: "閑散期と繁忙期の仕事量のムラをならして安定経営ができる",
        },
        {
          icon: "laptop",
          text: "リペア屋さんに頼まなくてもできるようになれるから、品質や経費や工期に安心できる",
        },
      ],
      support: [
        {
          title: "無料会員から始められる",
          text: "いきなり有料会員ではなく、まずは14日間の無料会員登録をして頂き、実際の会員となった際の学べるイメージを体感することが可能です！",
          img: "images/common/plan1.jpg",
        },
        {
          title: "個人のレベルに合わせたプラン",
          text: "リペアの仕事は、性別・年齢に大きな影響がない仕事なので、初心者の方・興味がある方・副業で始めたい方・既に仕事をしているがもっとバリバリやりたい方へそれぞれのプランをご用意しています。",
          img: "images/common/plan2.jpg",
        },
        {
          title: "卒業者のみ入会できるオンラインサロン",
          text: "同じ悩みを抱えた人にこそ知って学んでもらい、卒業したあともサロンで一緒に共有し協力し合って頑張りあえる仲間とともに、お互いに良くなる道に進みたいと心の底から思っています。",
          img: "images/common/plan3.jpg",
        },
        {
          title: "安心して副業・独立開始ができる",
          text: "いままでのステップから技術+ノウハウ+集客+経営・オンラインサロンでの情報集と仲間づくりにより初めてでも、副業・独立に踏み出しやすくなります！",
          img: "images/common/plan4.jpg",
        },
      ],
      course: [
        {
          ...
          text: "稼げる補修屋は対策が違う！10年後も勝ち続ける経営コンサル",
          kingaku: "120万円～",
          kikan: "約1年",
          youtube:
...

        {
          ...
          text: "空いた時間に毎日コツコツ学んでたった5ヶ月で開業できるオンラインリペアスクール",
          kingaku: "16,830円～/月額",
          kikan: "約5ヵ月",
          youtube:
      ...
      salons: [
        {
          url: "images/common/onlin-img4.jpg",
          title: "同じ志を持った仲間がたくさんいる",
          txt: "このRBSで学んだことで皆様の考え方や経営戦略は近いものになっていると思います。なので同じ方向性で仕事をしている仲間を作ることができます",
        },
        {
          url: "images/common/onlin-img2.jpg",
          title: "仲間からのスカウトや仕事の共有ができる",
          txt: "自身の現場の応援要請やお互いに協力できるパートナーやチームを作ったりと様々な交流をしていきます",
        },
        {
          url: "images/common/onlin-img3.jpg",
          title: "困りごとを解決！",
          txt: "困ったことやわからないことをサロンの先輩方にアドバイスを求めたり、質問相談をして、ちいさな疑問も解決！",
        },
      ],
      steps: [
        "RBSのコースの受講",
